 ...
 * @date      22. March 2008
 * @version   1.0
 * @revision  $Id: Ext.ux.grid.CellActions.js,v 1.1 2012/09/03 15:30:41 junctioner Exp $
 *
...
Ext.extend(Ext.ux.grid.CellActions, Ext.util.Observable, {
	...
	,tpl:'<div class="ux-cell-value" style="padding-left:{padding}px">'
			+'<tpl if="\'left\'!==align">{value}</tpl>'
		 	+'<span class="ux-cell-actions<tpl if="\'left\'===align"> ux-cell-actions-left</tpl>" style="width:{width}px">'
...
//		grid.on({scope:this, render:this.onRenderGrid});
	...
	,onClick:function(e, target) {
		...
		var c = this.grid.getColumnModel().config[col];
		var record=null, dataIndex=null, value=null, action=null;
		if(t) {
